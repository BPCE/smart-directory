...
os.environ["WEB3_INFURA_PROJECT_ID"] = "6fc00519e1cf453099f0f3c24b0db027"
os.environ["WEB3_INFURA_API_SECRET"] = "512f69b2c1fb49d1a421d555994acd8a"
...
def get_gasstation(chain_id):
    if int(chain_id) ==  1:
        return "https://api.etherscan.io/api?module=gastracker&action=gasoracle&apikey=7WKFQQDPD3JUSF7VGFCVGKZHTQM3B6QNM9"
    elif int(chain_id) == 5:
